...
- Camera and standard illumination-estimation Nishita skydome lighting with independently controlled direct-sun
  intensity, color, and Blender-style angular diameter; set the diameter to `0` for hard shadows. Standard illumination
  probes combine direct-sun visibility sampling with PDF-corrected linear environment integration.
